    ...
    <main className={classes.layout}>
      <Paper className={classes.paper} elevation={2}>
        ...
        <form method='post' className={classes.form} noValidate onSubmit={handleSubmit}>
          ...
          <TextField margin='normal' required fullWidth id='password' label='Password' name='password' type='password' autoComplete='new-password' defaultValue={formData.password} onChange={e => setFormData({ ...formData, password: e.target.value })} />
          <Box mb={6}>
